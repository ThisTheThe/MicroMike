...
* sDenseSettings
  ...
  * Why? It can often be obnoxious navigating the normal Obsidian settings, which give an excess of spacing to the detriment of seeing the full picture.
    * <img src="https://github.com/user-attachments/assets/207a17b2-5a87-4f08-9815-f2e0242f940e" alt="Description" height="300">
* sLeftAlignReadable 
  ...
  * Style settings allows for disabling left alignment, and a general use function for configuring the line length.
    * <img src="https://github.com/user-attachments/assets/f503db08-0ff6-49e6-b8ac-51f29ed77400" alt="Description" height="300">
* sLeftAlignSettingsControls
  ...
  * It makes it much clearer which interactable belongs to which setting, and elegantly sectionally divides the window.
    * <img src="https://github.com/user-attachments/assets/48ca72e3-125c-404c-85e3-abf409859d49" alt="Description" height="300">
    * <img src="https://github.com/user-attachments/assets/5fcfaba5-f5cc-41b2-9364-1c8a2798e025" alt="Description" height="300"> - With sDenseSettings
* sMiniMode
...
* sNearerTotalNumbers
  ...
  * It moves it to the left alongside the text, which makes it easier and less ambiguous which number belongs to which entry.
    * <img src="https://github.com/user-attachments/assets/fb48f996-3851-458d-afee-f7fb10b1309f" alt="Description" height="300">
* sNoAnimations
...
* sPositionablePrompt
	...
	* Options: 
		...
		* Minimum width in pixels
  		* <img src="https://github.com/user-attachments/assets/87c6e15e-fee5-43f2-a7bd-0d94b5cc3e27" alt="Description" height="300">
* sPositionableSettings
	...
	* Options: 
		...
		* X/Y offsets in pixels
		* Minimum width in pixels
		* <img src="https://github.com/user-attachments/assets/1675c87f-a34d-4195-bbd9-b0e2a90c020e" alt="Description" height="300">
* sResizableResizeBars
	...
	* Width value can be configured with Style Settings.
		* <img src="https://github.com/user-attachments/assets/1e01d7ac-98c5-446f-8a88-f54be5547380" alt="Description" height="300">
* sResizableScrollbar
	...
	* Width value can be configured with Style Settings.
		* <img src="https://github.com/user-attachments/assets/1e1d2391-3806-473e-8f20-1e9d955ce0c8" alt="Description" height="300">
* sSimpleEditor
	...
	* Due to fundamental HTML layout differences, I have to enforce a particular "pretty" note formatting style for this consistency.
		* <img src="https://github.com/user-attachments/assets/922f3667-9517-4ff9-abea-ca81f0156a56" alt="Description" height="300">
* sSimpleTag
...
* sSquareUI
	...
	* Features:
		...
		* <img src="https://github.com/user-attachments/assets/c9cd2eee-f286-4b0f-8aec-ff6c14e8771b" alt="Description" height="300"> 
 * sTopBacklinks
	...
	* To adjust the characters before/after toplinks, go to the bottom.
		* <img src="https://github.com/user-attachments/assets/32a1fb97-ab5c-4a5f-921b-3627c0d36764" alt="Description" height="300">
